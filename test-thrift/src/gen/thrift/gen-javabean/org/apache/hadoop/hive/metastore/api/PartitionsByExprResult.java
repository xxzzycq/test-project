...
public class PartitionsByExprResult implements org.apache.thrift.TBase<PartitionsByExprResult, PartitionsByExprResult._Fields>, java.io.Serializable, Cloneable, Comparable<PartitionsByExprResult> {
  ...
  public List<Partition> partitions; // required
  public boolean hasUnknownPartitions; // required
  ...
  public PartitionsByExprResult setPartitions(List<Partition> partitions) {
    this.partitions = partitions;
    return this;
  }
  ...
  public PartitionsByExprResult setHasUnknownPartitions(boolean hasUnknownPartitions) {
    this.hasUnknownPartitions = hasUnknownPartitions;
    setHasUnknownPartitionsIsSet(true);
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'hasUnknownPartitions' because it's a primitive and you chose the non-beans generator.
  ...
  private static class PartitionsByExprResultStandardScheme extends StandardScheme<PartitionsByExprResult> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, PartitionsByExprResult struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetHasUnknownPartitions()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'hasUnknownPartitions' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
