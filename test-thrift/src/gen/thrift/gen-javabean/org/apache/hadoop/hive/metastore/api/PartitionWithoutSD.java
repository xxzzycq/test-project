...
public class PartitionWithoutSD implements org.apache.thrift.TBase<PartitionWithoutSD, PartitionWithoutSD._Fields>, java.io.Serializable, Cloneable, Comparable<PartitionWithoutSD> {
  ...
  public String relativePath; // required
  ...
  public PartitionWithoutSD setValues(List<String> values) {
    this.values = values;
    return this;
  }
  ...
  public PartitionWithoutSD setCreateTime(int createTime) {
    this.createTime = createTime;
    setCreateTimeIsSet(true);
    return this;
  }
  ...
  public PartitionWithoutSD setLastAccessTime(int lastAccessTime) {
    this.lastAccessTime = lastAccessTime;
    setLastAccessTimeIsSet(true);
    return this;
  }
  ...
  public PartitionWithoutSD setRelativePath(String relativePath) {
    this.relativePath = relativePath;
    return this;
  }
  ...
  public PartitionWithoutSD setParameters(Map<String,String> parameters) {
    this.parameters = parameters;
    return this;
  }
  ...
  public PartitionWithoutSD setPrivileges(PrincipalPrivilegeSet privileges) {
