...
public class DoubleColumnStatsData implements org.apache.thrift.TBase<DoubleColumnStatsData, DoubleColumnStatsData._Fields>, java.io.Serializable, Cloneable, Comparable<DoubleColumnStatsData> {
  ...
  public double lowValue; // optional
  public double highValue; // optional
  ...
  public DoubleColumnStatsData setLowValue(double lowValue) {
  ...
  public DoubleColumnStatsData setHighValue(double highValue) {
  ...
  public DoubleColumnStatsData setNumNulls(long numNulls) {
    this.numNulls = numNulls;
    setNumNullsIsSet(true);
    return this;
  }
  ...
  public DoubleColumnStatsData setNumDVs(long numDVs) {
    this.numDVs = numDVs;
    setNumDVsIsSet(true);
    return this;
  }
