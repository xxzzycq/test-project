...
public class OpenTxnRequest implements org.apache.thrift.TBase<OpenTxnRequest, OpenTxnRequest._Fields>, java.io.Serializable, Cloneable, Comparable<OpenTxnRequest> {
  ...
  public OpenTxnRequest setNum_txns(int num_txns) {
    this.num_txns = num_txns;
    setNum_txnsIsSet(true);
    return this;
  }
  ...
  public OpenTxnRequest setUser(String user) {
    this.user = user;
    return this;
  }
  ...
  public OpenTxnRequest setHostname(String hostname) {
    this.hostname = hostname;
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'num_txns' because it's a primitive and you chose the non-beans generator.
    if (user == null) {
  ...
  private static class OpenTxnRequestStandardScheme extends StandardScheme<OpenTxnRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, OpenTxnRequest struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetNum_txns()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'num_txns' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
