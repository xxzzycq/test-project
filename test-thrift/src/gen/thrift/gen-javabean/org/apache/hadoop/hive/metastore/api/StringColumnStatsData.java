...
public class StringColumnStatsData implements org.apache.thrift.TBase<StringColumnStatsData, StringColumnStatsData._Fields>, java.io.Serializable, Cloneable, Comparable<StringColumnStatsData> {
  ...
  public long maxColLen; // required
  public double avgColLen; // required
  ...
  public StringColumnStatsData setMaxColLen(long maxColLen) {
    this.maxColLen = maxColLen;
    setMaxColLenIsSet(true);
    return this;
  }
  ...
  public StringColumnStatsData setAvgColLen(double avgColLen) {
    this.avgColLen = avgColLen;
    setAvgColLenIsSet(true);
    return this;
  }
  ...
  public StringColumnStatsData setNumNulls(long numNulls) {
    this.numNulls = numNulls;
    setNumNullsIsSet(true);
    return this;
  }
  ...
  public StringColumnStatsData setNumDVs(long numDVs) {
    this.numDVs = numDVs;
    setNumDVsIsSet(true);
    return this;
  }
