...
public class SkewedInfo implements org.apache.thrift.TBase<SkewedInfo, SkewedInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SkewedInfo> {
  ...
  public List<String> skewedColNames; // required
  public List<List<String>> skewedColValues; // required
  public Map<List<String>,String> skewedColValueLocationMaps; // required
  ...
  public SkewedInfo setSkewedColNames(List<String> skewedColNames) {
    this.skewedColNames = skewedColNames;
    return this;
  }
  ...
  public SkewedInfo setSkewedColValues(List<List<String>> skewedColValues) {
    this.skewedColValues = skewedColValues;
    return this;
  }
  ...
  public SkewedInfo setSkewedColValueLocationMaps(Map<List<String>,String> skewedColValueLocationMaps) {
    this.skewedColValueLocationMaps = skewedColValueLocationMaps;
    return this;
  }
