...
public class Partition implements org.apache.thrift.TBase<Partition, Partition._Fields>, java.io.Serializable, Cloneable, Comparable<Partition> {
  ...
  private static final _Fields optionals[] = {_Fields.PRIVILEGES,_Fields.INSTANCE_NAME,_Fields.INSTANCE_OWNER_NAME,_Fields.INSTANCE_OWNER_TYPE};
  ...
  public Partition setInstanceName(String instanceName) {
  ...
  public Partition setInstanceOwnerName(String instanceOwnerName) {
   ...
   * @see PrincipalType
   */
  public Partition setInstanceOwnerType(PrincipalType instanceOwnerType) {
