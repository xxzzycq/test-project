...
public class FireEventRequest implements org.apache.thrift.TBase<FireEventRequest, FireEventRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FireEventRequest> {
  ...
  public FireEventRequestData data; // required
  public String dbName; // optional
  public String tableName; // optional
  public List<String> partitionVals; // optional
  ...
  public FireEventRequest setSuccessful(boolean successful) {
    this.successful = successful;
    setSuccessfulIsSet(true);
    return this;
  }
  ...
  public FireEventRequest setData(FireEventRequestData data) {
    this.data = data;
    return this;
  }
  ...
  public FireEventRequest setDbName(String dbName) {
    this.dbName = dbName;
    return this;
  }
  ...
  public FireEventRequest setTableName(String tableName) {
  ...
  public FireEventRequest setPartitionVals(List<String> partitionVals) {
