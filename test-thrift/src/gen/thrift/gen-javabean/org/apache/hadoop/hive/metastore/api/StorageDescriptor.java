...
public class StorageDescriptor implements org.apache.thrift.TBase<StorageDescriptor, StorageDescriptor._Fields>, java.io.Serializable, Cloneable, Comparable<StorageDescriptor> {
  ...
  public List<FieldSchema> cols; // required
  public String location; // required
  public String inputFormat; // required
  public String outputFormat; // required
  public boolean compressed; // required
  public int numBuckets; // required
  public SerDeInfo serdeInfo; // required
  public List<String> bucketCols; // required
  public List<Order> sortCols; // required
  public Map<String,String> parameters; // required
  public SkewedInfo skewedInfo; // optional
  public boolean storedAsSubDirectories; // optional
