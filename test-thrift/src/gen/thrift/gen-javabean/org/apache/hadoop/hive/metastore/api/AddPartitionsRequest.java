...
public class AddPartitionsRequest implements org.apache.thrift.TBase<AddPartitionsRequest, AddPartitionsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AddPartitionsRequest> {
  ...
  public List<Partition> parts; // required
  public boolean ifNotExists; // required
  ...
  public AddPartitionsRequest setDbName(String dbName) {
    this.dbName = dbName;
    return this;
  }
  ...
  public AddPartitionsRequest setTblName(String tblName) {
    this.tblName = tblName;
    return this;
  }
  ...
  public AddPartitionsRequest setParts(List<Partition> parts) {
    this.parts = parts;
    return this;
  }
  ...
  public AddPartitionsRequest setIfNotExists(boolean ifNotExists) {
    this.ifNotExists = ifNotExists;
    setIfNotExistsIsSet(true);
    return this;
  }
  ...
  public AddPartitionsRequest setNeedResult(boolean needResult) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'ifNotExists' because it's a primitive and you chose the non-beans generator.
  ...
  private static class AddPartitionsRequestStandardScheme extends StandardScheme<AddPartitionsRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, AddPartitionsRequest struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetIfNotExists()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'ifNotExists' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
