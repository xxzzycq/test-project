...
struct Instance {
  1: string name,
  2: optional i32    createTime,
  3: string description,
  4: optional string ownerName,
  5: optional PrincipalType ownerType,
  6: string uname,
  7: string area,
  8: optional i32 updateTime
}
...
struct Database {
  ...
  9: optional string instanceName = "default",
  10: optional string instanceOwnerName,
  11: optional PrincipalType instanceOwnerType
}
...
struct Table {
  ...
  15: optional string instanceName = "default",
  16: optional string instanceOwnerName,
  17: optional PrincipalType instanceOwnerType
}
...
struct PartitionSpec {
  ...
  6: optional string instanceName = "default",
  7: optional string instanceOwnerName,
  8: optional PrincipalType instanceOwnerType
}
...
struct Index {
  ...
  11: optional string instanceName = "default",
  12: optional string instanceOwnerName,
  13: optional PrincipalType instanceOwnerType
}
...
service ThriftHiveMetastore extends fb303.FacebookService
{
  ...
  // add for instance
  void create_instance(1:Instance instance) throws(1:AlreadyExistsException o1, 2:InvalidObjectException o2, 3:MetaException o3)
  // add
  Instance get_instance(1:string name, 2:string owner_name, 3:PrincipalType owner_type) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<Instance> get_instance_list(1:string principal_name, 2:PrincipalType principal_type) throws(1:MetaException o1)
  // add
  void drop_instance(1:Instance instcreateDatabaseance, 2:bool deleteData, 3:bool cascade) throws(1:NoSuchObjectException o1, 2:InvalidOperationException o2, 3:MetaException o3)
  // add
  void alter_instance(1:string instanceName, 2:Instance instance) throws(1:MetaException o1, 2:NoSuchObjectException o2)
  // add
  bool grant_instance_privileges(1:Instance instance, 2:string principal_name 3:PrincipalType principal_type 4:PrivilegeGrantInfo info) throws(1:MetaException o1)
  // add
  bool revoke_instance_privileges(1:Instance instance, 2:string principal_name 3:PrincipalType principal_type 4:PrivilegeGrantInfo info) throws(1:MetaException o1)
  // add
  list<string> get_instance_privileges(1:Instance instance, 2:string principal_name 3:PrincipalType principal_type)throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  Database get_db(1:Instance instance, 2:string name) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  void drop_db(1:Database database, 2:bool deleteData, 3:bool cascade) throws(1:NoSuchObjectException o1, 2:InvalidOperationException o2, 3:MetaException o3)
  // add
  list<string> get_database_list(1:Instance instance, 2:string principal_name, 3:PrincipalType principal_type) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<Database> get_database_entity_list(1:Instance instance, 2:string principal_name, 3:PrincipalType principal_type) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<string> get_dbs(1:Instance instance, 2:string pattern) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<string> get_all_dbs(1:Instance instance) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  ...
  void drop_table_with_environment_context(1:string dbname, 2:string name, 3:bool deleteData,
      4:EnvironmentContext environment_context)
                       throws(1:NoSuchObjectException o1, 2:MetaException o3)
  // add
  void drop_tbl(1:Database database, 2:string name, 3:bool deleteData)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  void drop_tbl_with_environment_context(1:Database database, 2:string name, 3:bool deleteData,
      4:EnvironmentContext environment_context)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  list<string> get_tables(1: string db_name, 2: string pattern) throws (1: MetaException o1)
  // add
  list<string> get_tbls(1: Database database, 2: string pattern) throws (1:NoSuchObjectException o1, 2:MetaException o2)
  list<string> get_all_tables(1: string db_name) throws (1: MetaException o1)
  // add
  list<string> get_all_tbls(1: Database database) throws (1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<string> get_table_list(1: Database database, 2: string principal_name, 3: PrincipalType principal_type) throws (1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<Table> get_table_entity_list(1: Database database, 2: string principal_name, 3: PrincipalType principal_type) throws (1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<string> get_all_users() throws(1:MetaException o1)
  // add
  list<string> get_db_location_uri(1:Instance instance) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<HiveObjectPrivilege> list_privileges_for_principal(1:Instance instance, 2:string principal_name, 3:PrincipalType principal_type) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<HiveObjectPrivilege> list_privileges_for_grantor(1:Instance instance, 2:string grantor_name, 3:PrincipalType principal_type) throws(1:NoSuchObjectException o1, 2:MetaException o2)


  Table get_table(1:string dbname, 2:string tbl_name)
                       throws (1:MetaException o1, 2:NoSuchObjectException o2)
  // add
  Table get_tbl(1:Database database, 2:string tbl_name)
                       throws (1:MetaException o1, 2:NoSuchObjectException o2)
  list<Table> get_table_objects_by_name(1:string dbname, 2:list<string> tbl_names)
				   throws (1:MetaException o1, 2:InvalidOperationException o2, 3:UnknownDBException o3)
  // add
  list<Table> get_tbl_objects_by_name(1:Database database, 2:list<string> tbl_names)
  				   throws (1:MetaException o1, 2:InvalidOperationException o2, 3:UnknownDBException o3)
  ...
  // add
  void alter_tbl(1:Database database, 2:string tbl_name, 3:Table new_tbl)
                       throws (1:InvalidOperationException o1, 2:MetaException o2)
  void alter_table_with_environment_context(1:string dbname, 2:string tbl_name,
      ...
      throws (1:InvalidOperationException o1, 2:MetaException o2)
  // add
  void alter_tbl_with_environment_context(1:Database database, 2:string tbl_name,
      3:Table new_tbl, 4:EnvironmentContext environment_context)
      throws (1:InvalidOperationException o1, 2:MetaException o2)
  ...
  void alter_table_with_cascade(1:string dbname, 2:string tbl_name, 3:Table new_tbl, 4:bool cascade)
                       throws (1:InvalidOperationException o1, 2:MetaException o2)
  // add
  void alter_tbl_with_cascade(1:Database database, 2:string tbl_name, 3:Table new_tbl, 4:bool cascade)
                       throws (1:InvalidOperationException o1, 2:MetaException o2)
  ...
  Partition append_partition(1:string db_name, 2:string tbl_name, 3:list<string> part_vals)
                       throws (1:InvalidObjectException o1, 2:AlreadyExistsException o2, 3:MetaException o3)
  // add
  Partition append_part(1:Database database, 2:string tbl_name, 3:list<string> part_vals)
                         throws (1:InvalidObjectException o1, 2:AlreadyExistsException o2, 3:MetaException o3)
  AddPartitionsResult add_partitions_req(1:AddPartitionsRequest request)
                       throws(1:InvalidObjectException o1, 2:AlreadyExistsException o2, 3:MetaException o3)
  // add
  AddPartitionsResult add_parts_req(1:AddPartitionsRequest request, 2:Instance instance)
                         throws(1:InvalidObjectException o1, 2:AlreadyExistsException o2, 3:MetaException o3)
  Partition append_partition_with_environment_context(1:string db_name, 2:string tbl_name,
      3:list<string> part_vals, 4:EnvironmentContext environment_context)
                       throws (1:InvalidObjectException o1, 2:AlreadyExistsException o2, 3:MetaException o3)
  // add
  Partition append_part_with_environment_context(1:Database database, 2:string tbl_name,
        3:list<string> part_vals, 4:EnvironmentContext environment_context)
                         throws (1:InvalidObjectException o1, 2:AlreadyExistsException o2, 3:MetaException o3)
  ...
  bool drop_partition(1:string db_name, 2:string tbl_name, 3:list<string> part_vals, 4:bool deleteData)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  bool drop_part(1:Database database, 2:string tbl_name, 3:list<string> part_vals, 4:bool deleteData)
                         throws(1:NoSuchObjectException o1, 2:MetaException o2)
  bool drop_partition_with_environment_context(1:string db_name, 2:string tbl_name,
      3:list<string> part_vals, 4:bool deleteData, 5:EnvironmentContext environment_context)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  bool drop_part_with_environment_context(1:Database database, 2:string tbl_name,
        3:list<string> part_vals, 4:bool deleteData, 5:EnvironmentContext environment_context)
                         throws(1:NoSuchObjectException o1, 2:MetaException o2)
  bool drop_partition_by_name(1:string db_name, 2:string tbl_name, 3:string part_name, 4:bool deleteData)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  bool drop_part_by_name(1:Database database, 2:string tbl_name, 3:string part_name, 4:bool deleteData)
                         throws(1:NoSuchObjectException o1, 2:MetaException o2)
  bool drop_partition_by_name_with_environment_context(1:string db_name, 2:string tbl_name,
      3:string part_name, 4:bool deleteData, 5:EnvironmentContext environment_context)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  bool drop_part_by_name_with_environment_context(1:string db_name, 2:string tbl_name,
        3:string part_name, 4:bool deleteData, 5:EnvironmentContext environment_context)
                         throws(1:NoSuchObjectException o1, 2:MetaException o2)
  DropPartitionsResult drop_partitions_req(1: DropPartitionsRequest req)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  DropPartitionsResult drop_parts_req(1: DropPartitionsRequest req, 2:Instance instance)
                         throws(1:NoSuchObjectException o1, 2:MetaException o2)
  Partition get_partition(1:string db_name, 2:string tbl_name, 3:list<string> part_vals)
                       throws(1:MetaException o1, 2:NoSuchObjectException o2)
  // add
  Partition get_part(1:Database database, 2:string tbl_name, 3:list<string> part_vals)
                       throws(1:MetaException o1, 2:NoSuchObjectException o2)
  ...
  // add
  Partition get_part_with_auth(1:Database database, 2:string tbl_name, 3:list<string> part_vals,
        4: string user_name, 5: list<string> group_names) throws(1:MetaException o1, 2:NoSuchObjectException o2)

  Partition get_partition_by_name(1:string db_name 2:string tbl_name, 3:string part_name)
                       throws(1:MetaException o1, 2:NoSuchObjectException o2)
  //add
  Partition get_part_by_name(1:Database database 2:string tbl_name, 3:string part_name)
                         throws(1:MetaException o1, 2:NoSuchObjectException o2)
  ...
  list<Partition> get_partitions(1:string db_name, 2:string tbl_name, 3:i16 max_parts=-1)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<Partition> get_parts(1:Database database, 2:string tbl_name, 3:i16 max_parts=-1)
                         throws(1:NoSuchObjectException o1, 2:MetaException o2)
  ...
  //add
  list<Partition> get_parts_with_auth(1:Database database, 2:string tbl_name, 3:i16 max_parts=-1,
       4: string user_name, 5: list<string> group_names) throws(1:NoSuchObjectException o1, 2:MetaException o2)

  list<PartitionSpec> get_partitions_pspec(1:string db_name, 2:string tbl_name, 3:i32 max_parts=-1)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  //add
  list<PartitionSpec> get_parts_pspec(1:Database database, 2:string tbl_name, 3:i32 max_parts=-1)
                         throws(1:NoSuchObjectException o1, 2:MetaException o2)

  list<string> get_partition_names(1:string db_name, 2:string tbl_name, 3:i16 max_parts=-1)
                       throws(1:MetaException o2)
  // add
  list<string> get_part_names(1:Database database, 2:string tbl_name, 3:i16 max_parts=-1)
                       throws(1:MetaException o2)
  ...
  list<Partition> get_partitions_ps(1:string db_name 2:string tbl_name
  	3:list<string> part_vals, 4:i16 max_parts=-1)
                       throws(1:MetaException o1, 2:NoSuchObjectException o2)
  // add
  list<Partition> get_parts_ps(1:Database database 2:string tbl_name
    	3:list<string> part_vals, 4:i16 max_parts=-1)
                         throws(1:MetaException o1, 2:NoSuchObjectException o2)
  ...
  // add
  list<Partition> get_parts_ps_with_auth(1:Database database, 2:string tbl_name, 3:list<string> part_vals, 4:i16 max_parts=-1,
       5: string user_name, 6: list<string> group_names) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  ...
  list<string> get_partition_names_ps(1:string db_name,
  	2:string tbl_name, 3:list<string> part_vals, 4:i16 max_parts=-1)
  	                   throws(1:MetaException o1, 2:NoSuchObjectException o2)
  // add
  list<string> get_part_names_ps(1:Database database,
    	2:string tbl_name, 3:list<string> part_vals, 4:i16 max_parts=-1)
    	                   throws(1:MetaException o1, 2:NoSuchObjectException o2)
  ...
  list<Partition> get_partitions_by_filter(1:string db_name 2:string tbl_name
    3:string filter, 4:i16 max_parts=-1)
                       throws(1:MetaException o1, 2:NoSuchObjectException o2)
  // add
  list<Partition> get_parts_by_filter(1:Database database 2:string tbl_name
      3:string filter, 4:i16 max_parts=-1)
                         throws(1:MetaException o1, 2:NoSuchObjectException o2)
  ...
  PartitionsByExprResult get_partitions_by_expr(1:PartitionsByExprRequest req)
                       throws(1:MetaException o1, 2:NoSuchObjectException o2)
  // add
  PartitionsByExprResult get_parts_by_expr(1:string instanceName, 2:PartitionsByExprRequest req)
                       throws(1:MetaException o1, 2:NoSuchObjectException o2)
  ...
  list<Partition> get_partitions_by_names(1:string db_name 2:string tbl_name 3:list<string> names)
                       throws(1:MetaException o1, 2:NoSuchObjectException o2)
  // add
  list<Partition> get_parts_by_names(1:Database database 2:string tbl_name 3:list<string> names)
                         throws(1:MetaException o1, 2:NoSuchObjectException o2)
  ...
  void alter_partition(1:string db_name, 2:string tbl_name, 3:Partition new_part)
                       throws (1:InvalidOperationException o1, 2:MetaException o2)
  // add
  void alter_part(1:Database database, 2:string tbl_name, 3:Partition new_part)
                         throws (1:InvalidOperationException o1, 2:MetaException o2)
  ...
  void alter_partitions(1:string db_name, 2:string tbl_name, 3:list<Partition> new_parts)
                       throws (1:InvalidOperationException o1, 2:MetaException o2)
  // add
  void alter_parts(1:Database database, 2:string tbl_name, 3:list<Partition> new_parts)
                         throws (1:InvalidOperationException o1, 2:MetaException o2)
  ...
  void alter_partition_with_environment_context(1:string db_name,
      ...
      throws (1:InvalidOperationException o1, 2:MetaException o2)
  // add
  void alter_part_with_environment_context(1:Database database,
        2:string tbl_name, 3:Partition new_part,
        4:EnvironmentContext environment_context)
        throws (1:InvalidOperationException o1, 2:MetaException o2)
  ...
  void rename_partition(1:string db_name, 2:string tbl_name, 3:list<string> part_vals, 4:Partition new_part)
                       throws (1:InvalidOperationException o1, 2:MetaException o2)
  // add
  void rename_part(1:Database database, 2:string tbl_name, 3:list<string> part_vals, 4:Partition new_part)
                         throws (1:InvalidOperationException o1, 2:MetaException o2)
  ...
  Index get_index_by_name(1:string db_name 2:string tbl_name, 3:string index_name)
                       throws(1:MetaException o1, 2:NoSuchObjectException o2)
  // add
  Index get_idx_by_name(1:Database database 2:string tbl_name, 3:string index_name)
                       throws(1:MetaException o1, 2:NoSuchObjectException o2)
  list<Index> get_indexes(1:string db_name, 2:string tbl_name, 3:i16 max_indexes=-1)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // add
  list<Index> get_idxs(1:Database database, 2:string tbl_name, 3:i16 max_indexes=-1)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  list<string> get_index_names(1:string db_name, 2:string tbl_name, 3:i16 max_indexes=-1)
                       throws(1:MetaException o2)
  // add
  list<string> get_idx_names(1:Database database, 2:string tbl_name, 3:i16 max_indexes=-1)
                       throws(1:MetaException o2)
  ...
  void drop_function(1:string dbName, 2:string funcName)
      throws (1:NoSuchObjectException o1, 2:MetaException o3)
  // add
  void drop_func(1:Database database, 2:string funcName)
      throws (1:NoSuchObjectException o1, 2:MetaException o3)
  ...
  list<string> get_functions(1:string dbName, 2:string pattern)
      throws (1:MetaException o1)
  // add
  list<string> get_funcs(1:Database database, 2:string pattern)
      throws (1:MetaException o1)
  ...
  // add
  PrincipalPrivilegeSet get_priv_set(1:Instance instance, 2:HiveObjectRef hiveObject, 3:string user_name,
    4: list<string> group_names) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  ...
  // add
  bool grant_privs(1:Instance instance, 2:PrivilegeBag privileges) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  // Deprecated, use grant_revoke_privileges()
  bool revoke_privileges(1:PrivilegeBag privileges) throws(1:MetaException o1)
  // add
  bool revoke_privs(1:Instance instance, 2:PrivilegeBag privileges) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  GrantRevokePrivilegeResponse grant_revoke_privileges(1:GrantRevokePrivilegeRequest request) throws(1:MetaException o1);
  // add
  GrantRevokePrivilegeResponse grant_revoke_privs(1:Instance instance, 2:GrantRevokePrivilegeRequest request) throws(1:NoSuchObjectException o1, 2:MetaException o2);
